...
const ContactComponent = () => {
    ...
    return (<div className={`mt-5 p-25 bg-zinc-900 flex justify-center items-center flex-col ${font.className}`}>
        <div>
            ...
            <div className="w-full flex justify-center">
                <form className="w-full max-w-2xl grid grid-cols-1 md:grid-cols-2 gap-4 width-25" onSubmit={submitForm}>
                    <input className="border p-2 rounded border-gray-500"
                        id="name"
                        type="text"
                        minLength={3}
                    ...
                    <input className="border p-2 rounded border-gray-500"
                        ...
                        tabIndex={2}
                        required />
                    <textarea className="border p-2 rounded md:col-span-2 border-gray-500"
                        required
                        minLength={15}
